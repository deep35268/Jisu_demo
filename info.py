...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003976997552"))
...
URL = environ.get("URL", "https://jisu-demo.onrender.com/")  # ⚠️ "your-render-app-name" ਨੂੰ ਆਪਣੇ Render App ਦੇ ਨਾਮ ਨਾਲ ਬਦਲੋ
